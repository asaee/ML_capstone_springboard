...
- [5. Text pre-processing](#5-text-pre-processing)
- [6. EDA and Feature Engineering](#6-eda-and-feature-engineering)
  - [6.1. Length analysis](#61-length-analysis)
  - [6.2. Named entity recognition (NER)](#62-named-entity-recognition-ner)
  - [6.3. Word cloud](#63-word-cloud)
- [7. Text vectorization](#7-text-vectorization) 
  - [7.1. TF-IDF](#71-tf-idf) 
  - [7.2. Distributed representation](#72-distributed-representation)
- [8. Machine learning models](#8-machine-learning-models)
  - [8.1. Experiment with a prototype](#81-experiment-with-a-prototype)
    - [8.1.1. NaiveBayes](#811-naivebayes)
    - [8.1.2. Logistic regression](#812-logistic-regression)
    - [8.1.3. Support vector machine (SVM)](#813-support-vector-machine-svm)
  - [8.2. Hyper-parameter optimization](#82-hyper-parameter-optimization)
    - [8.2.1. BayesSearchCV](#821-bayessearchcv)
    - [8.2.2. Merge topic area](#822-merge-topic-area)
    - [8.2.3. NaiveBayes](#823-naivebayes)
    - [8.2.4. Logistic regression](#824-logistic-regression)
  - [8.3. Classification model using the distributed representation](#83-classification-model-using-the-distributed-representation)
    - [8.3.1. Train the Doc2Vec model](#831-train-the-doc2vec-model)
    - [8.3.2. Classification with logistic regression](#832-classification-with-logistic-regression)
- [9. Deep learning models](#9-deep-learning-models)
  - [9.1. Data processing](#91-data-processing)
  - [9.2. Convolutional neural network (CNN)](#92-convolutional-neural-network-cnn)
  - [9.3. CNN + LSTM](#93-cnn--lstm)
  - [9.4. BERT](#94-bert)
- [10. Model deployment](#10-model-deployment)
  - [10.1. Production ready code and testing](#101-production-ready-code-and-testing)
  - [10.2. FastAPI](#102-fastapi)
  - [10.3. Containerization](#103-containerization)
  - [10.4. CI/CD with GitHub actions](#104-cicd-with-github-actions)
  - [10.5. AWS elastic container services (ECS)](#105-aws-elastic-container-services-ecs)
  - [Appendix 1. Project Organization](#appendix-1-project-organization)
